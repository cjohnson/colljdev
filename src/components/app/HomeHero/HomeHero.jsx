...
import iconInfoData from '@/data/iconInfo.json';

export default function HomeHero() {
  const heroTitle = 'Pursuing a career in Software Engineering.';
  const heroDescription = 'Collin Johnson is pursuing a degree in Computer Science and Engineering (CSE) at the University of Michigan College of Engineering. He is a Software Development Trainee intern at AdvantageCS.';
    ...
    <section className="home-hero bg-white dark:bg-gray-900">
      <div className="home-hero-content grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="home-hero-main-content mr-auto place-self-start lg:col-span-7 md:pl-6">
          ...
          <HomeHeroIconInfo data={iconInfoData} />
        </div>
